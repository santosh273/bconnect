...
/**
 * Generated class for the AsoCompletedPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-aso-completed',
  templateUrl: 'aso-completed.html',
})
export class AsoCompletedPage {
  ...
  getCompleted(emdidx:any){
    ...
    this.http.get(Enums.APIURL.URL+'fetchadminsalesorderviewlist/'+emdidx+'/1').map(res => res.json()).subscribe(data => {
      // debugger;
